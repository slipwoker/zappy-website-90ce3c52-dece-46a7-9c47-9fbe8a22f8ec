document.addEventListener('DOMContentLoaded', function () {
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            ...
            let successEl = contactForm.querySelector('.form-success-banner');
            if (!successEl) {
        ...
        .catch(function () {
          ...
          let errorBanner = contactForm.querySelector('.form-error-banner');
          if (!errorBanner) {
  ...
  const animationObserverCallback = function (entries, observer) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "SWER משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '90ce3c52-dece-46a7-9c47-9fbe8a22f8ec',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '90ce3c52-dece-46a7-9c47-9fbe8a22f8ec';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '90ce3c52-dece-46a7-9c47-9fbe8a22f8ec';
